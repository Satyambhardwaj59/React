    ...
    return (
        <div className="shadow-md fixed top-0 w-11/12">
            <div className="md:flex justify-between bg-gray-200 py-4">
                ...
                {/* <div onClick={ () => !setShowMenu(true)} className="text-3xl absolute right-8 top-6 cursor-pointer md:hidden">
                    {showMenu ? '✖' : '☰'}
                </div> */}
                <div className="text-3xl absolute right-8 top-6 cursor-pointer md:hidden">
                    <ion-icon name="menu"></ion-icon>
                </div>
                <ul className="md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-blue-800 md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-10 transition-all duration-500 ease-in">
